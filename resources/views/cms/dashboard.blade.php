        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card o-hidden h-100">
                    ...
                    <a href="{{url('/posts')}}" class="card-footer clearfix small z-1">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5">
                            {{ $categories->count() }} Kategoria(e)!
                        </div>
                    </div>
                    <a href="{{url('/categories')}}" class="card-footer clearfix small z-1">
                        <span class="float-left">Zobacz wszystkie</span>
                        <span class="float-right">
                            <i class="fa fa-angle-right"></i>
                        </span>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5">
                            {{ $footballs->count() }} Top 5 zawodnik(ów)!
                        </div>
                    </div>
                    <a href="{{url('top-five')}}" class="card-footer clearfix small z-1">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5">
                            {{ $matches->count() }} Mecz(y)!
                        </div>
                    </div>
                    <a href="{{url('/match')}}" class="card-footer clearfix small z-1">
                        <span class="float-left">Zobacz wszystkie</span>
                        <span class="float-right">
                            <i class="fa fa-angle-right"></i>
                        </span>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5">
                            {{ $media->count() }} Obraz(ów)!
                        </div>
                    </div>
                    <a href="{{url('/media')}}" class="card-footer clearfix small z-1">
                        <span class="float-left">Zobacz wszystkie</span>
                        <span class="float-right">
                            <i class="fa fa-angle-right"></i>
                        </span>
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5">
                                {{ $newsletters->count() }} Zapisanych do newsletter(a)!
                            </div>
                        </div>
                        <a href="{{url('/get-newsletter')}}" class="card-footer clearfix small z-1">
                            <span class="float-left">Zobacz wszystkich</span>
                            <span class="float-right">
                                <i class="fa fa-angle-right"></i>
                            </span>
